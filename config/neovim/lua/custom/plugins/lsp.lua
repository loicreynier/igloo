...
return {
  {
    ...
    config = function()
      ...
      local has_self_install = not (
        vim.tbl_contains(vim.g.system_options, "nix")
        or vim.tbl_contains(vim.g.system_options, "offline")
      )
        ...
        lua_ls = {
          ...
          on_init = function(client)
            if client.workspace_folders then
              ...
              if
                fs_stat(path .. "/.luarc.json")
                or fs_stat(path .. "/.luarc.jsonc")
              then
                return
              end
            end
...

  {
    ...
    config = function()
      ...
      vim.keymap.set("", "<Leader>l", function()
        ...
        desc = "Change diagnostic style (virtual text / `lsp_lines`)",
      })
    end,
  },
